...
4.EQUIPAMENTO | INTERFACE |  ENDEREÇO IPv4  |   MÁSCARA SUBREDE    |   GATEWAY
      ...
      R1      |   R1.I2   |  192.168.31.66  | 255.255.255.252 / 30 | -----------
...
7.1.3. Endereço de sumarização de rede: 192.168.32.0
       Máscara de subrede: 255.255.255.0 /24
7.1.4. Rota estática R1 > R3 `enable` > `configure terminal` > `ip route 192.168.32.0 255.255.255.0 192.168.31.66`
